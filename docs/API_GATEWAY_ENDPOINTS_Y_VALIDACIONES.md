...
### GET /api/auth/me?user_id={id} - (AUTHENTICATED)
...
### GET /api/auth/email/{email} - (ADMIN ONLY)
Auth Gateway: ADMIN
...
### PUT /api/medications/{medicationId}/branch/{branchId}/stock - (ADMIN ONLY)
Auth Gateway: ADMIN
...
### GET /api/orders/cart?affiliateId={id}&branchId={id} - (AFFILIATE ONLY)
Auth Gateway: AFFILIATE
...
### POST /api/orders/{branchId}/confirm?affiliateId={id} - (AFFILIATE ONLY)
Auth Gateway: AFFILIATE
...
### PUT /api/logistics/deliveries/{id}/location - (DELIVERY ONLY)
...
### PUT /api/logistics/deliveries/{id}/complete - (DELIVERY ONLY)
Auth Gateway: DELIVERY
...
### GET /api/logistics/deliveries/active?deliveryPersonId={id} - (DELIVERY ONLY)
Auth Gateway: DELIVERY
...
### GET /api/logistics/deliveries/{id}?deliveryPersonId={id} - (DELIVERY ONLY)
Auth Gateway: DELIVERY
...
### POST /api/logistics/deliveries/assign - (ADMIN ONLY)
Auth Gateway: ADMIN
...
### PUT /api/auctions/{id} - (ADMIN ONLY)
Auth Gateway: ADMIN
...
### POST /api/auctions/{id}/join?userId={id} - (ADMIN + AFFILIATE)
Auth Gateway: ADMIN, AFFILIATE
